...
module hps_design_mm_interconnect_0 (
		input  wire [11:0] SMP_HPS_h2f_lw_axi_master_awid,                                        //                                       SMP_HPS_h2f_lw_axi_master.awid
		input  wire [20:0] SMP_HPS_h2f_lw_axi_master_awaddr,                                      //                                                                .awaddr
		input  wire [3:0]  SMP_HPS_h2f_lw_axi_master_awlen,                                       //                                                                .awlen
		input  wire [2:0]  SMP_HPS_h2f_lw_axi_master_awsize,                                      //                                                                .awsize
		input  wire [1:0]  SMP_HPS_h2f_lw_axi_master_awburst,                                     //                                                                .awburst
		input  wire [1:0]  SMP_HPS_h2f_lw_axi_master_awlock,                                      //                                                                .awlock
		input  wire [3:0]  SMP_HPS_h2f_lw_axi_master_awcache,                                     //                                                                .awcache
		input  wire [2:0]  SMP_HPS_h2f_lw_axi_master_awprot,                                      //                                                                .awprot
		input  wire        SMP_HPS_h2f_lw_axi_master_awvalid,                                     //                                                                .awvalid
		output wire        SMP_HPS_h2f_lw_axi_master_awready,                                     //                                                                .awready
		input  wire [11:0] SMP_HPS_h2f_lw_axi_master_wid,                                         //                                                                .wid
		input  wire [31:0] SMP_HPS_h2f_lw_axi_master_wdata,                                       //                                                                .wdata
		input  wire [3:0]  SMP_HPS_h2f_lw_axi_master_wstrb,                                       //                                                                .wstrb
		input  wire        SMP_HPS_h2f_lw_axi_master_wlast,                                       //                                                                .wlast
		input  wire        SMP_HPS_h2f_lw_axi_master_wvalid,                                      //                                                                .wvalid
		output wire        SMP_HPS_h2f_lw_axi_master_wready,                                      //                                                                .wready
		output wire [11:0] SMP_HPS_h2f_lw_axi_master_bid,                                         //                                                                .bid
		output wire [1:0]  SMP_HPS_h2f_lw_axi_master_bresp,                                       //                                                                .bresp
		output wire        SMP_HPS_h2f_lw_axi_master_bvalid,                                      //                                                                .bvalid
		input  wire        SMP_HPS_h2f_lw_axi_master_bready,                                      //                                                                .bready
		input  wire [11:0] SMP_HPS_h2f_lw_axi_master_arid,                                        //                                                                .arid
		input  wire [20:0] SMP_HPS_h2f_lw_axi_master_araddr,                                      //                                                                .araddr
		input  wire [3:0]  SMP_HPS_h2f_lw_axi_master_arlen,                                       //                                                                .arlen
		input  wire [2:0]  SMP_HPS_h2f_lw_axi_master_arsize,                                      //                                                                .arsize
		input  wire [1:0]  SMP_HPS_h2f_lw_axi_master_arburst,                                     //                                                                .arburst
		input  wire [1:0]  SMP_HPS_h2f_lw_axi_master_arlock,                                      //                                                                .arlock
		input  wire [3:0]  SMP_HPS_h2f_lw_axi_master_arcache,                                     //                                                                .arcache
		input  wire [2:0]  SMP_HPS_h2f_lw_axi_master_arprot,                                      //                                                                .arprot
		input  wire        SMP_HPS_h2f_lw_axi_master_arvalid,                                     //                                                                .arvalid
		output wire        SMP_HPS_h2f_lw_axi_master_arready,                                     //                                                                .arready
		output wire [11:0] SMP_HPS_h2f_lw_axi_master_rid,                                         //                                                                .rid
		output wire [31:0] SMP_HPS_h2f_lw_axi_master_rdata,                                       //                                                                .rdata
		output wire [1:0]  SMP_HPS_h2f_lw_axi_master_rresp,                                       //                                                                .rresp
		output wire        SMP_HPS_h2f_lw_axi_master_rlast,                                       //                                                                .rlast
		output wire        SMP_HPS_h2f_lw_axi_master_rvalid,                                      //                                                                .rvalid
		input  wire        SMP_HPS_h2f_lw_axi_master_rready,                                      //                                                                .rready
		...
		input  wire        SMP_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset, // SMP_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                      // rsp_mux:src_valid -> SMP_HPS_h2f_lw_axi_master_agent:write_rp_valid
	wire  [111:0] rsp_mux_src_data;                                       // rsp_mux:src_data -> SMP_HPS_h2f_lw_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                                      // SMP_HPS_h2f_lw_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                    // rsp_mux:src_channel -> SMP_HPS_h2f_lw_axi_master_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                              // rsp_mux:src_startofpacket -> SMP_HPS_h2f_lw_axi_master_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                // rsp_mux:src_endofpacket -> SMP_HPS_h2f_lw_axi_master_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                                  // rsp_mux_001:src_valid -> SMP_HPS_h2f_lw_axi_master_agent:read_rp_valid
	wire  [111:0] rsp_mux_001_src_data;                                   // rsp_mux_001:src_data -> SMP_HPS_h2f_lw_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                  // SMP_HPS_h2f_lw_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                // rsp_mux_001:src_channel -> SMP_HPS_h2f_lw_axi_master_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                          // rsp_mux_001:src_startofpacket -> SMP_HPS_h2f_lw_axi_master_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                            // rsp_mux_001:src_endofpacket -> SMP_HPS_h2f_lw_axi_master_agent:read_rp_endofpacket
	...
	wire          smp_hps_h2f_lw_axi_master_agent_write_cp_valid;         // SMP_HPS_h2f_lw_axi_master_agent:write_cp_valid -> router:sink_valid
	wire  [111:0] smp_hps_h2f_lw_axi_master_agent_write_cp_data;          // SMP_HPS_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	wire          smp_hps_h2f_lw_axi_master_agent_write_cp_ready;         // router:sink_ready -> SMP_HPS_h2f_lw_axi_master_agent:write_cp_ready
	wire          smp_hps_h2f_lw_axi_master_agent_write_cp_startofpacket; // SMP_HPS_h2f_lw_axi_master_agent:write_cp_startofpacket -> router:sink_startofpacket
	wire          smp_hps_h2f_lw_axi_master_agent_write_cp_endofpacket;   // SMP_HPS_h2f_lw_axi_master_agent:write_cp_endofpacket -> router:sink_endofpacket
	...
	wire          smp_hps_h2f_lw_axi_master_agent_read_cp_valid;          // SMP_HPS_h2f_lw_axi_master_agent:read_cp_valid -> router_001:sink_valid
	wire  [111:0] smp_hps_h2f_lw_axi_master_agent_read_cp_data;           // SMP_HPS_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	wire          smp_hps_h2f_lw_axi_master_agent_read_cp_ready;          // router_001:sink_ready -> SMP_HPS_h2f_lw_axi_master_agent:read_cp_ready
	wire          smp_hps_h2f_lw_axi_master_agent_read_cp_startofpacket;  // SMP_HPS_h2f_lw_axi_master_agent:read_cp_startofpacket -> router_001:sink_startofpacket
	wire          smp_hps_h2f_lw_axi_master_agent_read_cp_endofpacket;    // SMP_HPS_h2f_lw_axi_master_agent:read_cp_endofpacket -> router_001:sink_endofpacket
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~SMP_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //        clk_reset.reset_n
		.write_cp_valid         (smp_hps_h2f_lw_axi_master_agent_write_cp_valid),                         //         write_cp.valid
		.write_cp_data          (smp_hps_h2f_lw_axi_master_agent_write_cp_data),                          //                 .data
		.write_cp_startofpacket (smp_hps_h2f_lw_axi_master_agent_write_cp_startofpacket),                 //                 .startofpacket
		.write_cp_endofpacket   (smp_hps_h2f_lw_axi_master_agent_write_cp_endofpacket),                   //                 .endofpacket
		.write_cp_ready         (smp_hps_h2f_lw_axi_master_agent_write_cp_ready),                         //                 .ready
		...
		.read_cp_valid          (smp_hps_h2f_lw_axi_master_agent_read_cp_valid),                          //          read_cp.valid
		.read_cp_data           (smp_hps_h2f_lw_axi_master_agent_read_cp_data),                           //                 .data
		.read_cp_startofpacket  (smp_hps_h2f_lw_axi_master_agent_read_cp_startofpacket),                  //                 .startofpacket
		.read_cp_endofpacket    (smp_hps_h2f_lw_axi_master_agent_read_cp_endofpacket),                    //                 .endofpacket
		.read_cp_ready          (smp_hps_h2f_lw_axi_master_agent_read_cp_ready),                          //                 .ready
		...
		.awid                   (SMP_HPS_h2f_lw_axi_master_awid),                                         // altera_axi_slave.awid
		.awaddr                 (SMP_HPS_h2f_lw_axi_master_awaddr),                                       //                 .awaddr
		.awlen                  (SMP_HPS_h2f_lw_axi_master_awlen),                                        //                 .awlen
		.awsize                 (SMP_HPS_h2f_lw_axi_master_awsize),                                       //                 .awsize
		.awburst                (SMP_HPS_h2f_lw_axi_master_awburst),                                      //                 .awburst
		.awlock                 (SMP_HPS_h2f_lw_axi_master_awlock),                                       //                 .awlock
		.awcache                (SMP_HPS_h2f_lw_axi_master_awcache),                                      //                 .awcache
		.awprot                 (SMP_HPS_h2f_lw_axi_master_awprot),                                       //                 .awprot
		.awvalid                (SMP_HPS_h2f_lw_axi_master_awvalid),                                      //                 .awvalid
		.awready                (SMP_HPS_h2f_lw_axi_master_awready),                                      //                 .awready
		.wid                    (SMP_HPS_h2f_lw_axi_master_wid),                                          //                 .wid
		.wdata                  (SMP_HPS_h2f_lw_axi_master_wdata),                                        //                 .wdata
		.wstrb                  (SMP_HPS_h2f_lw_axi_master_wstrb),                                        //                 .wstrb
		.wlast                  (SMP_HPS_h2f_lw_axi_master_wlast),                                        //                 .wlast
		.wvalid                 (SMP_HPS_h2f_lw_axi_master_wvalid),                                       //                 .wvalid
		.wready                 (SMP_HPS_h2f_lw_axi_master_wready),                                       //                 .wready
		.bid                    (SMP_HPS_h2f_lw_axi_master_bid),                                          //                 .bid
		.bresp                  (SMP_HPS_h2f_lw_axi_master_bresp),                                        //                 .bresp
		.bvalid                 (SMP_HPS_h2f_lw_axi_master_bvalid),                                       //                 .bvalid
		.bready                 (SMP_HPS_h2f_lw_axi_master_bready),                                       //                 .bready
		.arid                   (SMP_HPS_h2f_lw_axi_master_arid),                                         //                 .arid
		.araddr                 (SMP_HPS_h2f_lw_axi_master_araddr),                                       //                 .araddr
		.arlen                  (SMP_HPS_h2f_lw_axi_master_arlen),                                        //                 .arlen
		.arsize                 (SMP_HPS_h2f_lw_axi_master_arsize),                                       //                 .arsize
		.arburst                (SMP_HPS_h2f_lw_axi_master_arburst),                                      //                 .arburst
		.arlock                 (SMP_HPS_h2f_lw_axi_master_arlock),                                       //                 .arlock
		.arcache                (SMP_HPS_h2f_lw_axi_master_arcache),                                      //                 .arcache
		.arprot                 (SMP_HPS_h2f_lw_axi_master_arprot),                                       //                 .arprot
		.arvalid                (SMP_HPS_h2f_lw_axi_master_arvalid),                                      //                 .arvalid
		.arready                (SMP_HPS_h2f_lw_axi_master_arready),                                      //                 .arready
		.rid                    (SMP_HPS_h2f_lw_axi_master_rid),                                          //                 .rid
		.rdata                  (SMP_HPS_h2f_lw_axi_master_rdata),                                        //                 .rdata
		.rresp                  (SMP_HPS_h2f_lw_axi_master_rresp),                                        //                 .rresp
		.rlast                  (SMP_HPS_h2f_lw_axi_master_rlast),                                        //                 .rlast
		.rvalid                 (SMP_HPS_h2f_lw_axi_master_rvalid),                                       //                 .rvalid
		.rready                 (SMP_HPS_h2f_lw_axi_master_rready),                                       //                 .rready
	...
	hps_design_mm_interconnect_0_router router (
		.sink_ready         (smp_hps_h2f_lw_axi_master_agent_write_cp_ready),                        //      sink.ready
		.sink_valid         (smp_hps_h2f_lw_axi_master_agent_write_cp_valid),                        //          .valid
		.sink_data          (smp_hps_h2f_lw_axi_master_agent_write_cp_data),                         //          .data
		.sink_startofpacket (smp_hps_h2f_lw_axi_master_agent_write_cp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (smp_hps_h2f_lw_axi_master_agent_write_cp_endofpacket),                  //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                                     //       clk.clk
		.reset              (SMP_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_design_mm_interconnect_0_router router_001 (
		.sink_ready         (smp_hps_h2f_lw_axi_master_agent_read_cp_ready),                         //      sink.ready
		.sink_valid         (smp_hps_h2f_lw_axi_master_agent_read_cp_valid),                         //          .valid
		.sink_data          (smp_hps_h2f_lw_axi_master_agent_read_cp_data),                          //          .data
		.sink_startofpacket (smp_hps_h2f_lw_axi_master_agent_read_cp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (smp_hps_h2f_lw_axi_master_agent_read_cp_endofpacket),                   //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                                     //       clk.clk
		.reset              (SMP_HPS_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
