...
(
    ...
    localparam PAD4 = log2ceil(64'h4041c00 - 64'h4041800); 
    localparam PAD5 = log2ceil(64'h4041c20 - 64'h4041c00); 
    localparam PAD6 = log2ceil(64'h4041c28 - 64'h4041c20); 
    localparam PAD7 = log2ceil(64'h4041c30 - 64'h4041c28); 
    localparam PAD8 = log2ceil(64'h4041c38 - 64'h4041c30); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4041c38;
    ...
    // ( 0x4041c00 .. 0x4041c20 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 27'h4041c00   ) begin
            src_channel = 9'b100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x4041c20 .. 0x4041c28 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4041c20  && read_transaction  ) begin
            src_channel = 9'b010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x4041c28 .. 0x4041c30 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4041c28   ) begin
            src_channel = 9'b000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x4041c30 .. 0x4041c38 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4041c30   ) begin
