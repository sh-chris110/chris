...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k "$QSYS_SIMDIR/submodules/hps_design_pll_0.vo" -work pll_0
  vlogan +v2k "$QSYS_SIMDIR/submodules/hps_design_pio_0.v"  -work pio_0
  vlogan +v2k "$QSYS_SIMDIR/submodules/hps_design_hps_0.v"  -work hps_0
  vlogan +v2k "$QSYS_SIMDIR/hps_design.v"                              
fi
