...
TOP_LEVEL_NAME="hps_design"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/chris/altera/15.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/hps_design_pll_0.vo" -work pll_0 -cdslib ./cds_libs/pll_0.cds.lib
  ncvlog "$QSYS_SIMDIR/submodules/hps_design_pio_0.v"  -work pio_0 -cdslib ./cds_libs/pio_0.cds.lib
  ncvlog "$QSYS_SIMDIR/submodules/hps_design_hps_0.v"  -work hps_0 -cdslib ./cds_libs/hps_0.cds.lib
  ncvlog "$QSYS_SIMDIR/hps_design.v"                                                               
fi
