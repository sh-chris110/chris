...
alias com {
  echo "\[exec\] com"
  vlog "$QSYS_SIMDIR/submodules/hps_design_pll_0.vo" -work pll_0
  vlog "$QSYS_SIMDIR/submodules/hps_design_pio_0.v"  -work pio_0
  vlog "$QSYS_SIMDIR/submodules/hps_design_hps_0.v"  -work hps_0
  vlog "$QSYS_SIMDIR/hps_design.v"                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L pll_0 -L pio_0 -L hps_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L pll_0 -L pio_0 -L hps_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
