...
module soc_design_mm_interconnect_0 (
		...
		input  wire [25:0] General_DMA_read_master_address,               //                 General_DMA_read_master.address
		output wire        General_DMA_read_master_waitrequest,           //                                        .waitrequest
		input  wire        General_DMA_read_master_chipselect,            //                                        .chipselect
		input  wire        General_DMA_read_master_read,                  //                                        .read
		output wire [15:0] General_DMA_read_master_readdata,              //                                        .readdata
		output wire        General_DMA_read_master_readdatavalid,         //                                        .readdatavalid
		input  wire [25:0] General_DMA_write_master_address,              //                General_DMA_write_master.address
		output wire        General_DMA_write_master_waitrequest,          //                                        .waitrequest
		input  wire [1:0]  General_DMA_write_master_byteenable,           //                                        .byteenable
		input  wire        General_DMA_write_master_chipselect,           //                                        .chipselect
		input  wire        General_DMA_write_master_write,                //                                        .write
		input  wire [15:0] General_DMA_write_master_writedata,            //                                        .writedata
		...
		output wire [2:0]  General_DMA_control_port_slave_address,        //          General_DMA_control_port_slave.address
		output wire        General_DMA_control_port_slave_write,          //                                        .write
		input  wire [25:0] General_DMA_control_port_slave_readdata,       //                                        .readdata
		output wire [25:0] General_DMA_control_port_slave_writedata,      //                                        .writedata
		output wire        General_DMA_control_port_slave_chipselect,     //                                        .chipselect
	...
	wire          general_dma_read_master_translator_avalon_universal_master_0_waitrequest;          // General_DMA_read_master_agent:av_waitrequest -> General_DMA_read_master_translator:uav_waitrequest
	wire   [15:0] general_dma_read_master_translator_avalon_universal_master_0_readdata;             // General_DMA_read_master_agent:av_readdata -> General_DMA_read_master_translator:uav_readdata
	wire          general_dma_read_master_translator_avalon_universal_master_0_debugaccess;          // General_DMA_read_master_translator:uav_debugaccess -> General_DMA_read_master_agent:av_debugaccess
	wire   [26:0] general_dma_read_master_translator_avalon_universal_master_0_address;              // General_DMA_read_master_translator:uav_address -> General_DMA_read_master_agent:av_address
	wire          general_dma_read_master_translator_avalon_universal_master_0_read;                 // General_DMA_read_master_translator:uav_read -> General_DMA_read_master_agent:av_read
	wire    [1:0] general_dma_read_master_translator_avalon_universal_master_0_byteenable;           // General_DMA_read_master_translator:uav_byteenable -> General_DMA_read_master_agent:av_byteenable
	wire          general_dma_read_master_translator_avalon_universal_master_0_readdatavalid;        // General_DMA_read_master_agent:av_readdatavalid -> General_DMA_read_master_translator:uav_readdatavalid
	wire          general_dma_read_master_translator_avalon_universal_master_0_lock;                 // General_DMA_read_master_translator:uav_lock -> General_DMA_read_master_agent:av_lock
	wire          general_dma_read_master_translator_avalon_universal_master_0_write;                // General_DMA_read_master_translator:uav_write -> General_DMA_read_master_agent:av_write
	wire   [15:0] general_dma_read_master_translator_avalon_universal_master_0_writedata;            // General_DMA_read_master_translator:uav_writedata -> General_DMA_read_master_agent:av_writedata
	wire    [1:0] general_dma_read_master_translator_avalon_universal_master_0_burstcount;           // General_DMA_read_master_translator:uav_burstcount -> General_DMA_read_master_agent:av_burstcount
	wire          rsp_mux_002_src_valid;                                                             // rsp_mux_002:src_valid -> General_DMA_read_master_agent:rp_valid
	wire   [92:0] rsp_mux_002_src_data;                                                              // rsp_mux_002:src_data -> General_DMA_read_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                             // General_DMA_read_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [8:0] rsp_mux_002_src_channel;                                                           // rsp_mux_002:src_channel -> General_DMA_read_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                                     // rsp_mux_002:src_startofpacket -> General_DMA_read_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                       // rsp_mux_002:src_endofpacket -> General_DMA_read_master_agent:rp_endofpacket
	wire          general_dma_write_master_translator_avalon_universal_master_0_waitrequest;         // General_DMA_write_master_agent:av_waitrequest -> General_DMA_write_master_translator:uav_waitrequest
	wire   [15:0] general_dma_write_master_translator_avalon_universal_master_0_readdata;            // General_DMA_write_master_agent:av_readdata -> General_DMA_write_master_translator:uav_readdata
	wire          general_dma_write_master_translator_avalon_universal_master_0_debugaccess;         // General_DMA_write_master_translator:uav_debugaccess -> General_DMA_write_master_agent:av_debugaccess
	wire   [26:0] general_dma_write_master_translator_avalon_universal_master_0_address;             // General_DMA_write_master_translator:uav_address -> General_DMA_write_master_agent:av_address
	wire          general_dma_write_master_translator_avalon_universal_master_0_read;                // General_DMA_write_master_translator:uav_read -> General_DMA_write_master_agent:av_read
	wire    [1:0] general_dma_write_master_translator_avalon_universal_master_0_byteenable;          // General_DMA_write_master_translator:uav_byteenable -> General_DMA_write_master_agent:av_byteenable
	wire          general_dma_write_master_translator_avalon_universal_master_0_readdatavalid;       // General_DMA_write_master_agent:av_readdatavalid -> General_DMA_write_master_translator:uav_readdatavalid
	wire          general_dma_write_master_translator_avalon_universal_master_0_lock;                // General_DMA_write_master_translator:uav_lock -> General_DMA_write_master_agent:av_lock
	wire          general_dma_write_master_translator_avalon_universal_master_0_write;               // General_DMA_write_master_translator:uav_write -> General_DMA_write_master_agent:av_write
	wire   [15:0] general_dma_write_master_translator_avalon_universal_master_0_writedata;           // General_DMA_write_master_translator:uav_writedata -> General_DMA_write_master_agent:av_writedata
	wire    [1:0] general_dma_write_master_translator_avalon_universal_master_0_burstcount;          // General_DMA_write_master_translator:uav_burstcount -> General_DMA_write_master_agent:av_burstcount
	wire          rsp_mux_003_src_valid;                                                             // rsp_mux_003:src_valid -> General_DMA_write_master_agent:rp_valid
	wire   [92:0] rsp_mux_003_src_data;                                                              // rsp_mux_003:src_data -> General_DMA_write_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                             // General_DMA_write_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [8:0] rsp_mux_003_src_channel;                                                           // rsp_mux_003:src_channel -> General_DMA_write_master_agent:rp_channel
	wire          rsp_mux_003_src_startofpacket;                                                     // rsp_mux_003:src_startofpacket -> General_DMA_write_master_agent:rp_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                                       // rsp_mux_003:src_endofpacket -> General_DMA_write_master_agent:rp_endofpacket
	...
	wire   [26:0] uart_com_avalon_rs232_slave_agent_m0_address;                                      // UART_COM_avalon_rs232_slave_agent:m0_address -> UART_COM_avalon_rs232_slave_translator:uav_address
	...
	wire  [111:0] uart_com_avalon_rs232_slave_agent_rf_source_data;                                  // UART_COM_avalon_rs232_slave_agent:rf_source_data -> UART_COM_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [111:0] uart_com_avalon_rs232_slave_agent_rsp_fifo_out_data;                               // UART_COM_avalon_rs232_slave_agent_rsp_fifo:out_data -> UART_COM_avalon_rs232_slave_agent:rf_sink_data
	...
	wire  [111:0] convolution_slave_avs_s0_agent_rf_source_data;                                     // convolution_slave_avs_s0_agent:rf_source_data -> convolution_slave_avs_s0_agent_rsp_fifo:in_data
	...
	wire  [111:0] convolution_slave_avs_s0_agent_rsp_fifo_out_data;                                  // convolution_slave_avs_s0_agent_rsp_fifo:out_data -> convolution_slave_avs_s0_agent:rf_sink_data
	...
	wire   [31:0] general_dma_control_port_slave_agent_m0_readdata;                                  // General_DMA_control_port_slave_translator:uav_readdata -> General_DMA_control_port_slave_agent:m0_readdata
	wire          general_dma_control_port_slave_agent_m0_waitrequest;                               // General_DMA_control_port_slave_translator:uav_waitrequest -> General_DMA_control_port_slave_agent:m0_waitrequest
	wire          general_dma_control_port_slave_agent_m0_debugaccess;                               // General_DMA_control_port_slave_agent:m0_debugaccess -> General_DMA_control_port_slave_translator:uav_debugaccess
	wire   [26:0] general_dma_control_port_slave_agent_m0_address;                                   // General_DMA_control_port_slave_agent:m0_address -> General_DMA_control_port_slave_translator:uav_address
	wire    [3:0] general_dma_control_port_slave_agent_m0_byteenable;                                // General_DMA_control_port_slave_agent:m0_byteenable -> General_DMA_control_port_slave_translator:uav_byteenable
	wire          general_dma_control_port_slave_agent_m0_read;                                      // General_DMA_control_port_slave_agent:m0_read -> General_DMA_control_port_slave_translator:uav_read
	wire          general_dma_control_port_slave_agent_m0_readdatavalid;                             // General_DMA_control_port_slave_translator:uav_readdatavalid -> General_DMA_control_port_slave_agent:m0_readdatavalid
	wire          general_dma_control_port_slave_agent_m0_lock;                                      // General_DMA_control_port_slave_agent:m0_lock -> General_DMA_control_port_slave_translator:uav_lock
	wire   [31:0] general_dma_control_port_slave_agent_m0_writedata;                                 // General_DMA_control_port_slave_agent:m0_writedata -> General_DMA_control_port_slave_translator:uav_writedata
	wire          general_dma_control_port_slave_agent_m0_write;                                     // General_DMA_control_port_slave_agent:m0_write -> General_DMA_control_port_slave_translator:uav_write
	wire    [2:0] general_dma_control_port_slave_agent_m0_burstcount;                                // General_DMA_control_port_slave_agent:m0_burstcount -> General_DMA_control_port_slave_translator:uav_burstcount
	wire          general_dma_control_port_slave_agent_rf_source_valid;                              // General_DMA_control_port_slave_agent:rf_source_valid -> General_DMA_control_port_slave_agent_rsp_fifo:in_valid
	wire  [111:0] general_dma_control_port_slave_agent_rf_source_data;                               // General_DMA_control_port_slave_agent:rf_source_data -> General_DMA_control_port_slave_agent_rsp_fifo:in_data
	wire          general_dma_control_port_slave_agent_rf_source_ready;                              // General_DMA_control_port_slave_agent_rsp_fifo:in_ready -> General_DMA_control_port_slave_agent:rf_source_ready
	wire          general_dma_control_port_slave_agent_rf_source_startofpacket;                      // General_DMA_control_port_slave_agent:rf_source_startofpacket -> General_DMA_control_port_slave_agent_rsp_fifo:in_startofpacket
	wire          general_dma_control_port_slave_agent_rf_source_endofpacket;                        // General_DMA_control_port_slave_agent:rf_source_endofpacket -> General_DMA_control_port_slave_agent_rsp_fifo:in_endofpacket
	wire          general_dma_control_port_slave_agent_rsp_fifo_out_valid;                           // General_DMA_control_port_slave_agent_rsp_fifo:out_valid -> General_DMA_control_port_slave_agent:rf_sink_valid
	wire  [111:0] general_dma_control_port_slave_agent_rsp_fifo_out_data;                            // General_DMA_control_port_slave_agent_rsp_fifo:out_data -> General_DMA_control_port_slave_agent:rf_sink_data
	wire          general_dma_control_port_slave_agent_rsp_fifo_out_ready;                           // General_DMA_control_port_slave_agent:rf_sink_ready -> General_DMA_control_port_slave_agent_rsp_fifo:out_ready
	wire          general_dma_control_port_slave_agent_rsp_fifo_out_startofpacket;                   // General_DMA_control_port_slave_agent_rsp_fifo:out_startofpacket -> General_DMA_control_port_slave_agent:rf_sink_startofpacket
	wire          general_dma_control_port_slave_agent_rsp_fifo_out_endofpacket;                     // General_DMA_control_port_slave_agent_rsp_fifo:out_endofpacket -> General_DMA_control_port_slave_agent:rf_sink_endofpacket
	...
	wire  [111:0] systemid_control_slave_agent_rf_source_data;                                       // SystemID_control_slave_agent:rf_source_data -> SystemID_control_slave_agent_rsp_fifo:in_data
	...
	wire  [111:0] systemid_control_slave_agent_rsp_fifo_out_data;                                    // SystemID_control_slave_agent_rsp_fifo:out_data -> SystemID_control_slave_agent:rf_sink_data
	...
	wire  [111:0] niosii_core_debug_mem_slave_agent_rf_source_data;                                  // niosII_core_debug_mem_slave_agent:rf_source_data -> niosII_core_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [111:0] niosii_core_debug_mem_slave_agent_rsp_fifo_out_data;                               // niosII_core_debug_mem_slave_agent_rsp_fifo:out_data -> niosII_core_debug_mem_slave_agent:rf_sink_data
	...
	wire  [111:0] sram_s1_agent_rf_source_data;                                                      // SRAM_s1_agent:rf_source_data -> SRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [111:0] sram_s1_agent_rsp_fifo_out_data;                                                   // SRAM_s1_agent_rsp_fifo:out_data -> SRAM_s1_agent:rf_sink_data
	...
	wire  [111:0] sys_timer_s1_agent_rf_source_data;                                                 // Sys_Timer_s1_agent:rf_source_data -> Sys_Timer_s1_agent_rsp_fifo:in_data
	...
	wire  [111:0] sys_timer_s1_agent_rsp_fifo_out_data;                                              // Sys_Timer_s1_agent_rsp_fifo:out_data -> Sys_Timer_s1_agent:rf_sink_data
	...
	wire  [110:0] niosii_core_data_master_agent_cp_data;                                             // niosII_core_data_master_agent:cp_data -> router:sink_data
	...
	wire  [110:0] niosii_core_instruction_master_agent_cp_data;                                      // niosII_core_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire          general_dma_read_master_agent_cp_valid;                                            // General_DMA_read_master_agent:cp_valid -> router_002:sink_valid
	wire   [92:0] general_dma_read_master_agent_cp_data;                                             // General_DMA_read_master_agent:cp_data -> router_002:sink_data
	wire          general_dma_read_master_agent_cp_ready;                                            // router_002:sink_ready -> General_DMA_read_master_agent:cp_ready
	wire          general_dma_read_master_agent_cp_startofpacket;                                    // General_DMA_read_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          general_dma_read_master_agent_cp_endofpacket;                                      // General_DMA_read_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          general_dma_write_master_agent_cp_valid;                                           // General_DMA_write_master_agent:cp_valid -> router_003:sink_valid
	wire   [92:0] general_dma_write_master_agent_cp_data;                                            // General_DMA_write_master_agent:cp_data -> router_003:sink_data
	wire          general_dma_write_master_agent_cp_ready;                                           // router_003:sink_ready -> General_DMA_write_master_agent:cp_ready
	wire          general_dma_write_master_agent_cp_startofpacket;                                   // General_DMA_write_master_agent:cp_startofpacket -> router_003:sink_startofpacket
	wire          general_dma_write_master_agent_cp_endofpacket;                                     // General_DMA_write_master_agent:cp_endofpacket -> router_003:sink_endofpacket
	...
	wire          uart_com_avalon_rs232_slave_agent_rp_valid;                                        // UART_COM_avalon_rs232_slave_agent:rp_valid -> router_005:sink_valid
	wire  [110:0] uart_com_avalon_rs232_slave_agent_rp_data;                                         // UART_COM_avalon_rs232_slave_agent:rp_data -> router_005:sink_data
	wire          uart_com_avalon_rs232_slave_agent_rp_ready;                                        // router_005:sink_ready -> UART_COM_avalon_rs232_slave_agent:rp_ready
	wire          uart_com_avalon_rs232_slave_agent_rp_startofpacket;                                // UART_COM_avalon_rs232_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          uart_com_avalon_rs232_slave_agent_rp_endofpacket;                                  // UART_COM_avalon_rs232_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          convolution_slave_avs_s0_agent_rp_valid;                                           // convolution_slave_avs_s0_agent:rp_valid -> router_006:sink_valid
	wire  [110:0] convolution_slave_avs_s0_agent_rp_data;                                            // convolution_slave_avs_s0_agent:rp_data -> router_006:sink_data
	wire          convolution_slave_avs_s0_agent_rp_ready;                                           // router_006:sink_ready -> convolution_slave_avs_s0_agent:rp_ready
	wire          convolution_slave_avs_s0_agent_rp_startofpacket;                                   // convolution_slave_avs_s0_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          convolution_slave_avs_s0_agent_rp_endofpacket;                                     // convolution_slave_avs_s0_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          general_dma_control_port_slave_agent_rp_valid;                                     // General_DMA_control_port_slave_agent:rp_valid -> router_007:sink_valid
	wire  [110:0] general_dma_control_port_slave_agent_rp_data;                                      // General_DMA_control_port_slave_agent:rp_data -> router_007:sink_data
	wire          general_dma_control_port_slave_agent_rp_ready;                                     // router_007:sink_ready -> General_DMA_control_port_slave_agent:rp_ready
	wire          general_dma_control_port_slave_agent_rp_startofpacket;                             // General_DMA_control_port_slave_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          general_dma_control_port_slave_agent_rp_endofpacket;                               // General_DMA_control_port_slave_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          systemid_control_slave_agent_rp_valid;                                             // SystemID_control_slave_agent:rp_valid -> router_008:sink_valid
	wire  [110:0] systemid_control_slave_agent_rp_data;                                              // SystemID_control_slave_agent:rp_data -> router_008:sink_data
	wire          systemid_control_slave_agent_rp_ready;                                             // router_008:sink_ready -> SystemID_control_slave_agent:rp_ready
	wire          systemid_control_slave_agent_rp_startofpacket;                                     // SystemID_control_slave_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          systemid_control_slave_agent_rp_endofpacket;                                       // SystemID_control_slave_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          niosii_core_debug_mem_slave_agent_rp_valid;                                        // niosII_core_debug_mem_slave_agent:rp_valid -> router_009:sink_valid
	wire  [110:0] niosii_core_debug_mem_slave_agent_rp_data;                                         // niosII_core_debug_mem_slave_agent:rp_data -> router_009:sink_data
	wire          niosii_core_debug_mem_slave_agent_rp_ready;                                        // router_009:sink_ready -> niosII_core_debug_mem_slave_agent:rp_ready
	wire          niosii_core_debug_mem_slave_agent_rp_startofpacket;                                // niosII_core_debug_mem_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          niosii_core_debug_mem_slave_agent_rp_endofpacket;                                  // niosII_core_debug_mem_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          sram_s1_agent_rp_valid;                                                            // SRAM_s1_agent:rp_valid -> router_010:sink_valid
	wire  [110:0] sram_s1_agent_rp_data;                                                             // SRAM_s1_agent:rp_data -> router_010:sink_data
	wire          sram_s1_agent_rp_ready;                                                            // router_010:sink_ready -> SRAM_s1_agent:rp_ready
	wire          sram_s1_agent_rp_startofpacket;                                                    // SRAM_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          sram_s1_agent_rp_endofpacket;                                                      // SRAM_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [110:0] sys_timer_s1_agent_rp_data;                                                        // Sys_Timer_s1_agent:rp_data -> router_011:sink_data
	...
	wire   [92:0] sdram_s1_agent_rp_data;                                                            // SDRAM_s1_agent:rp_data -> router_012:sink_data
	...
	wire   [92:0] router_012_src_data;                                                               // router_012:src_data -> rsp_demux_008:sink_data
	...
	wire  [110:0] router_src_data;                                                                   // router:src_data -> niosII_core_data_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                  // niosII_core_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [8:0] router_src_channel;                                                                // router:src_channel -> niosII_core_data_master_limiter:cmd_sink_channel
	...
	wire  [110:0] niosii_core_data_master_limiter_cmd_src_data;                                      // niosII_core_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          niosii_core_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> niosII_core_data_master_limiter:cmd_src_ready
	wire    [8:0] niosii_core_data_master_limiter_cmd_src_channel;                                   // niosII_core_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [110:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> niosII_core_data_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                 // niosII_core_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [8:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> niosII_core_data_master_limiter:rsp_sink_channel
	...
	wire  [110:0] niosii_core_data_master_limiter_rsp_src_data;                                      // niosII_core_data_master_limiter:rsp_src_data -> niosII_core_data_master_agent:rp_data
	...
	wire  [110:0] router_001_src_data;                                                               // router_001:src_data -> niosII_core_instruction_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                              // niosII_core_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [8:0] router_001_src_channel;                                                            // router_001:src_channel -> niosII_core_instruction_master_limiter:cmd_sink_channel
	...
	wire  [110:0] niosii_core_instruction_master_limiter_cmd_src_data;                               // niosII_core_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [8:0] niosii_core_instruction_master_limiter_cmd_src_channel;                            // niosII_core_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [110:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> niosII_core_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                             // niosII_core_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [8:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> niosII_core_instruction_master_limiter:rsp_sink_channel
	...
	wire  [110:0] niosii_core_instruction_master_limiter_rsp_src_data;                               // niosII_core_instruction_master_limiter:rsp_src_data -> niosII_core_instruction_master_agent:rp_data
	...
	wire  [110:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> JTAG_avalon_jtag_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                 // JTAG_avalon_jtag_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> JTAG_avalon_jtag_slave_burst_adapter:sink0_channel
	...
	wire  [110:0] jtag_avalon_jtag_slave_burst_adapter_source0_data;                                 // JTAG_avalon_jtag_slave_burst_adapter:source0_data -> JTAG_avalon_jtag_slave_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                                             // cmd_mux_001:src_valid -> UART_COM_avalon_rs232_slave_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> UART_COM_avalon_rs232_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                             // UART_COM_avalon_rs232_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> UART_COM_avalon_rs232_slave_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                                     // cmd_mux_001:src_startofpacket -> UART_COM_avalon_rs232_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                       // cmd_mux_001:src_endofpacket -> UART_COM_avalon_rs232_slave_burst_adapter:sink0_endofpacket
	...
	wire  [110:0] uart_com_avalon_rs232_slave_burst_adapter_source0_data;                            // UART_COM_avalon_rs232_slave_burst_adapter:source0_data -> UART_COM_avalon_rs232_slave_agent:cp_data
	...
	wire          cmd_mux_002_src_valid;                                                             // cmd_mux_002:src_valid -> convolution_slave_avs_s0_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_002_src_data;                                                              // cmd_mux_002:src_data -> convolution_slave_avs_s0_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                             // convolution_slave_avs_s0_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                           // cmd_mux_002:src_channel -> convolution_slave_avs_s0_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                                     // cmd_mux_002:src_startofpacket -> convolution_slave_avs_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                       // cmd_mux_002:src_endofpacket -> convolution_slave_avs_s0_burst_adapter:sink0_endofpacket
	...
	wire  [110:0] convolution_slave_avs_s0_burst_adapter_source0_data;                               // convolution_slave_avs_s0_burst_adapter:source0_data -> convolution_slave_avs_s0_agent:cp_data
	...
	wire          cmd_mux_003_src_valid;                                                             // cmd_mux_003:src_valid -> General_DMA_control_port_slave_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_003_src_data;                                                              // cmd_mux_003:src_data -> General_DMA_control_port_slave_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                             // General_DMA_control_port_slave_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                           // cmd_mux_003:src_channel -> General_DMA_control_port_slave_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                                     // cmd_mux_003:src_startofpacket -> General_DMA_control_port_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                       // cmd_mux_003:src_endofpacket -> General_DMA_control_port_slave_burst_adapter:sink0_endofpacket
	wire          general_dma_control_port_slave_burst_adapter_source0_valid;                        // General_DMA_control_port_slave_burst_adapter:source0_valid -> General_DMA_control_port_slave_agent:cp_valid
	wire  [110:0] general_dma_control_port_slave_burst_adapter_source0_data;                         // General_DMA_control_port_slave_burst_adapter:source0_data -> General_DMA_control_port_slave_agent:cp_data
	wire          general_dma_control_port_slave_burst_adapter_source0_ready;                        // General_DMA_control_port_slave_agent:cp_ready -> General_DMA_control_port_slave_burst_adapter:source0_ready
	wire    [8:0] general_dma_control_port_slave_burst_adapter_source0_channel;                      // General_DMA_control_port_slave_burst_adapter:source0_channel -> General_DMA_control_port_slave_agent:cp_channel
	wire          general_dma_control_port_slave_burst_adapter_source0_startofpacket;                // General_DMA_control_port_slave_burst_adapter:source0_startofpacket -> General_DMA_control_port_slave_agent:cp_startofpacket
	wire          general_dma_control_port_slave_burst_adapter_source0_endofpacket;                  // General_DMA_control_port_slave_burst_adapter:source0_endofpacket -> General_DMA_control_port_slave_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                                             // cmd_mux_004:src_valid -> SystemID_control_slave_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_004_src_data;                                                              // cmd_mux_004:src_data -> SystemID_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                             // SystemID_control_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                           // cmd_mux_004:src_channel -> SystemID_control_slave_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                     // cmd_mux_004:src_startofpacket -> SystemID_control_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                       // cmd_mux_004:src_endofpacket -> SystemID_control_slave_burst_adapter:sink0_endofpacket
	...
	wire  [110:0] systemid_control_slave_burst_adapter_source0_data;                                 // SystemID_control_slave_burst_adapter:source0_data -> SystemID_control_slave_agent:cp_data
	...
	wire          cmd_mux_005_src_valid;                                                             // cmd_mux_005:src_valid -> niosII_core_debug_mem_slave_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_005_src_data;                                                              // cmd_mux_005:src_data -> niosII_core_debug_mem_slave_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                             // niosII_core_debug_mem_slave_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                           // cmd_mux_005:src_channel -> niosII_core_debug_mem_slave_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                     // cmd_mux_005:src_startofpacket -> niosII_core_debug_mem_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                       // cmd_mux_005:src_endofpacket -> niosII_core_debug_mem_slave_burst_adapter:sink0_endofpacket
	...
	wire  [110:0] niosii_core_debug_mem_slave_burst_adapter_source0_data;                            // niosII_core_debug_mem_slave_burst_adapter:source0_data -> niosII_core_debug_mem_slave_agent:cp_data
	...
	wire          cmd_mux_006_src_valid;                                                             // cmd_mux_006:src_valid -> SRAM_s1_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_006_src_data;                                                              // cmd_mux_006:src_data -> SRAM_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                             // SRAM_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                           // cmd_mux_006:src_channel -> SRAM_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                     // cmd_mux_006:src_startofpacket -> SRAM_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                       // cmd_mux_006:src_endofpacket -> SRAM_s1_burst_adapter:sink0_endofpacket
	wire          sram_s1_burst_adapter_source0_valid;                                               // SRAM_s1_burst_adapter:source0_valid -> SRAM_s1_agent:cp_valid
	wire  [110:0] sram_s1_burst_adapter_source0_data;                                                // SRAM_s1_burst_adapter:source0_data -> SRAM_s1_agent:cp_data
	...
	wire          cmd_mux_007_src_valid;                                                             // cmd_mux_007:src_valid -> Sys_Timer_s1_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_007_src_data;                                                              // cmd_mux_007:src_data -> Sys_Timer_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                             // Sys_Timer_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                           // cmd_mux_007:src_channel -> Sys_Timer_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                     // cmd_mux_007:src_startofpacket -> Sys_Timer_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                       // cmd_mux_007:src_endofpacket -> Sys_Timer_s1_burst_adapter:sink0_endofpacket
	wire          sys_timer_s1_burst_adapter_source0_valid;                                          // Sys_Timer_s1_burst_adapter:source0_valid -> Sys_Timer_s1_agent:cp_valid
	wire  [110:0] sys_timer_s1_burst_adapter_source0_data;                                           // Sys_Timer_s1_burst_adapter:source0_data -> Sys_Timer_s1_agent:cp_data
	...
	wire   [92:0] cmd_mux_008_src_data;                                                              // cmd_mux_008:src_data -> SDRAM_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                             // SDRAM_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                           // cmd_mux_008:src_channel -> SDRAM_s1_burst_adapter:sink0_channel
	...
	wire   [92:0] cmd_demux_002_src0_data;                                                           // cmd_demux_002:src0_data -> cmd_mux_008:sink2_data
	wire          cmd_demux_002_src0_ready;                                                          // cmd_mux_008:sink2_ready -> cmd_demux_002:src0_ready
	wire    [8:0] cmd_demux_002_src0_channel;                                                        // cmd_demux_002:src0_channel -> cmd_mux_008:sink2_channel
	...
	wire   [92:0] cmd_demux_003_src0_data;                                                           // cmd_demux_003:src0_data -> cmd_mux_008:sink3_data
	wire          cmd_demux_003_src0_ready;                                                          // cmd_mux_008:sink3_ready -> cmd_demux_003:src0_ready
	wire    [8:0] cmd_demux_003_src0_channel;                                                        // cmd_demux_003:src0_channel -> cmd_mux_008:sink3_channel
	...
	wire   [92:0] rsp_demux_008_src2_data;                                                           // rsp_demux_008:src2_data -> rsp_mux_002:sink0_data
	wire          rsp_demux_008_src2_ready;                                                          // rsp_mux_002:sink0_ready -> rsp_demux_008:src2_ready
	wire    [8:0] rsp_demux_008_src2_channel;                                                        // rsp_demux_008:src2_channel -> rsp_mux_002:sink0_channel
	...
	wire   [92:0] rsp_demux_008_src3_data;                                                           // rsp_demux_008:src3_data -> rsp_mux_003:sink0_data
	wire          rsp_demux_008_src3_ready;                                                          // rsp_mux_003:sink0_ready -> rsp_demux_008:src3_ready
	wire    [8:0] rsp_demux_008_src3_channel;                                                        // rsp_demux_008:src3_channel -> rsp_mux_003:sink0_channel
	...
	wire          cmd_demux_src8_valid;                                                              // cmd_demux:src8_valid -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [110:0] cmd_demux_src8_data;                                                               // cmd_demux:src8_data -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_src8_ready;                                                              // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux:src8_ready
	wire    [8:0] cmd_demux_src8_channel;                                                            // cmd_demux:src8_channel -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_src8_startofpacket;                                                      // cmd_demux:src8_startofpacket -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src8_endofpacket;                                                        // cmd_demux:src8_endofpacket -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	wire          niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_valid;                   // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_008:sink0_valid
	wire   [92:0] niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_data;                    // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_008:sink0_data
	wire          niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_ready;                   // cmd_mux_008:sink0_ready -> niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [8:0] niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_channel;                 // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_008:sink0_channel
	wire          niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;           // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_008:sink0_startofpacket
	wire          niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;             // niosII_core_data_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_008:sink0_endofpacket
	wire          cmd_demux_001_src2_valid;                                                          // cmd_demux_001:src2_valid -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [110:0] cmd_demux_001_src2_data;                                                           // cmd_demux_001:src2_data -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_001_src2_ready;                                                          // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_001:src2_ready
	wire    [8:0] cmd_demux_001_src2_channel;                                                        // cmd_demux_001:src2_channel -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src2_startofpacket;                                                  // cmd_demux_001:src2_startofpacket -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src2_endofpacket;                                                    // cmd_demux_001:src2_endofpacket -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	wire          niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_valid;            // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_008:sink1_valid
	wire   [92:0] niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_data;             // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_008:sink1_data
	wire          niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_ready;            // cmd_mux_008:sink1_ready -> niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [8:0] niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_channel;          // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_008:sink1_channel
	wire          niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;    // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_008:sink1_startofpacket
	wire          niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;      // niosII_core_instruction_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_008:sink1_endofpacket
	wire          rsp_demux_008_src0_valid;                                                          // rsp_demux_008:src0_valid -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_valid
	wire   [92:0] rsp_demux_008_src0_data;                                                           // rsp_demux_008:src0_data -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_data
	wire          rsp_demux_008_src0_ready;                                                          // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_ready -> rsp_demux_008:src0_ready
	wire    [8:0] rsp_demux_008_src0_channel;                                                        // rsp_demux_008:src0_channel -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_channel
	wire          rsp_demux_008_src0_startofpacket;                                                  // rsp_demux_008:src0_startofpacket -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_008_src0_endofpacket;                                                    // rsp_demux_008:src0_endofpacket -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:in_endofpacket
	wire          sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_valid;                   // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_valid -> rsp_mux:sink8_valid
	wire  [110:0] sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_data;                    // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_data -> rsp_mux:sink8_data
	wire          sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_ready;                   // rsp_mux:sink8_ready -> SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_ready
	wire    [8:0] sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_channel;                 // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_channel -> rsp_mux:sink8_channel
	wire          sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_startofpacket;           // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_startofpacket -> rsp_mux:sink8_startofpacket
	wire          sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_endofpacket;             // SDRAM_s1_to_niosII_core_data_master_rsp_width_adapter:out_endofpacket -> rsp_mux:sink8_endofpacket
	wire          rsp_demux_008_src1_valid;                                                          // rsp_demux_008:src1_valid -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_valid
	wire   [92:0] rsp_demux_008_src1_data;                                                           // rsp_demux_008:src1_data -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_data
	wire          rsp_demux_008_src1_ready;                                                          // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_ready -> rsp_demux_008:src1_ready
	wire    [8:0] rsp_demux_008_src1_channel;                                                        // rsp_demux_008:src1_channel -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_channel
	wire          rsp_demux_008_src1_startofpacket;                                                  // rsp_demux_008:src1_startofpacket -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_008_src1_endofpacket;                                                    // rsp_demux_008:src1_endofpacket -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:in_endofpacket
	wire          sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_valid;            // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_valid -> rsp_mux_001:sink2_valid
	wire  [110:0] sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_data;             // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_data -> rsp_mux_001:sink2_data
	wire          sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_ready;            // rsp_mux_001:sink2_ready -> SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_ready
	wire    [8:0] sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_channel;          // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink2_channel
	wire          sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_startofpacket;    // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_startofpacket -> rsp_mux_001:sink2_startofpacket
	wire          sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_endofpacket;      // SDRAM_s1_to_niosII_core_instruction_master_rsp_width_adapter:out_endofpacket -> rsp_mux_001:sink2_endofpacket
	wire    [8:0] niosii_core_data_master_limiter_cmd_valid_data;                                    // niosII_core_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [8:0] niosii_core_instruction_master_limiter_cmd_valid_data;                             // niosII_core_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          uart_com_avalon_rs232_slave_agent_rdata_fifo_src_valid;                            // UART_COM_avalon_rs232_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] uart_com_avalon_rs232_slave_agent_rdata_fifo_src_data;                             // UART_COM_avalon_rs232_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          uart_com_avalon_rs232_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> UART_COM_avalon_rs232_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                 // avalon_st_adapter_001:out_0_valid -> UART_COM_avalon_rs232_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                  // avalon_st_adapter_001:out_0_data -> UART_COM_avalon_rs232_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                 // UART_COM_avalon_rs232_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                 // avalon_st_adapter_001:out_0_error -> UART_COM_avalon_rs232_slave_agent:rdata_fifo_sink_error
	wire          convolution_slave_avs_s0_agent_rdata_fifo_src_valid;                               // convolution_slave_avs_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] convolution_slave_avs_s0_agent_rdata_fifo_src_data;                                // convolution_slave_avs_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          convolution_slave_avs_s0_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_002:in_0_ready -> convolution_slave_avs_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                 // avalon_st_adapter_002:out_0_valid -> convolution_slave_avs_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                  // avalon_st_adapter_002:out_0_data -> convolution_slave_avs_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                 // convolution_slave_avs_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                 // avalon_st_adapter_002:out_0_error -> convolution_slave_avs_s0_agent:rdata_fifo_sink_error
	wire          general_dma_control_port_slave_agent_rdata_fifo_src_valid;                         // General_DMA_control_port_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] general_dma_control_port_slave_agent_rdata_fifo_src_data;                          // General_DMA_control_port_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          general_dma_control_port_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter_003:in_0_ready -> General_DMA_control_port_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                 // avalon_st_adapter_003:out_0_valid -> General_DMA_control_port_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                  // avalon_st_adapter_003:out_0_data -> General_DMA_control_port_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                 // General_DMA_control_port_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                 // avalon_st_adapter_003:out_0_error -> General_DMA_control_port_slave_agent:rdata_fifo_sink_error
	wire          systemid_control_slave_agent_rdata_fifo_src_valid;                                 // SystemID_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] systemid_control_slave_agent_rdata_fifo_src_data;                                  // SystemID_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          systemid_control_slave_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_004:in_0_ready -> SystemID_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                 // avalon_st_adapter_004:out_0_valid -> SystemID_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                  // avalon_st_adapter_004:out_0_data -> SystemID_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                 // SystemID_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                 // avalon_st_adapter_004:out_0_error -> SystemID_control_slave_agent:rdata_fifo_sink_error
	wire          niosii_core_debug_mem_slave_agent_rdata_fifo_src_valid;                            // niosII_core_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] niosii_core_debug_mem_slave_agent_rdata_fifo_src_data;                             // niosII_core_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          niosii_core_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_005:in_0_ready -> niosII_core_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                 // avalon_st_adapter_005:out_0_valid -> niosII_core_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                  // avalon_st_adapter_005:out_0_data -> niosII_core_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                 // niosII_core_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                 // avalon_st_adapter_005:out_0_error -> niosII_core_debug_mem_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) general_dma_read_master_translator (
		.clk                    (system_pll_outclk0_clk),                                                     //                       clk.clk
		.reset                  (niosII_core_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
		.uav_address            (general_dma_read_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (general_dma_read_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (general_dma_read_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (general_dma_read_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (general_dma_read_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (general_dma_read_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (general_dma_read_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (general_dma_read_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (general_dma_read_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (general_dma_read_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (general_dma_read_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (General_DMA_read_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (General_DMA_read_master_waitrequest),                                        //                          .waitrequest
		.av_chipselect          (General_DMA_read_master_chipselect),                                         //                          .chipselect
		.av_read                (General_DMA_read_master_read),                                               //                          .read
		.av_readdata            (General_DMA_read_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (General_DMA_read_master_readdatavalid),                                      //                          .readdatavalid
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) general_dma_write_master_translator (
		.clk                    (system_pll_outclk0_clk),                                                      //                       clk.clk
		.reset                  (niosII_core_reset_reset_bridge_in_reset_reset),                               //                     reset.reset
		.uav_address            (general_dma_write_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (general_dma_write_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (general_dma_write_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (general_dma_write_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (general_dma_write_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (general_dma_write_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (general_dma_write_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (general_dma_write_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (general_dma_write_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (general_dma_write_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (general_dma_write_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (General_DMA_write_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (General_DMA_write_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (General_DMA_write_master_byteenable),                                         //                          .byteenable
		.av_chipselect          (General_DMA_write_master_chipselect),                                         //                          .chipselect
		.av_write               (General_DMA_write_master_write),                                              //                          .write
		.av_writedata           (General_DMA_write_master_writedata),                                          //                          .writedata
		.av_burstcount          (1'b1),                                                                        //               (terminated)
		.av_beginbursttransfer  (1'b0),                                                                        //               (terminated)
		.av_begintransfer       (1'b0),                                                                        //               (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) general_dma_control_port_slave_translator (
		.clk                    (system_pll_outclk0_clk),                                //                      clk.clk
		.reset                  (niosII_core_reset_reset_bridge_in_reset_reset),         //                    reset.reset
		.uav_address            (general_dma_control_port_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (general_dma_control_port_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (general_dma_control_port_slave_agent_m0_read),          //                         .read
		.uav_write              (general_dma_control_port_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (general_dma_control_port_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (general_dma_control_port_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (general_dma_control_port_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (general_dma_control_port_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (general_dma_control_port_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (general_dma_control_port_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (general_dma_control_port_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (General_DMA_control_port_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (General_DMA_control_port_slave_write),                  //                         .write
		.av_readdata            (General_DMA_control_port_slave_readdata),               //                         .readdata
		.av_writedata           (General_DMA_control_port_slave_writedata),              //                         .writedata
		.av_chipselect          (General_DMA_control_port_slave_chipselect),             //                         .chipselect
		.av_read                (),                                                      //              (terminated)
		.av_begintransfer       (),                                                      //              (terminated)
		.av_beginbursttransfer  (),                                                      //              (terminated)
		.av_burstcount          (),                                                      //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) general_dma_read_master_agent (
		.clk                   (system_pll_outclk0_clk),                                                     //       clk.clk
		.reset                 (niosII_core_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
		.av_address            (general_dma_read_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (general_dma_read_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (general_dma_read_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (general_dma_read_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (general_dma_read_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (general_dma_read_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (general_dma_read_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (general_dma_read_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (general_dma_read_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (general_dma_read_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (general_dma_read_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (general_dma_read_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (general_dma_read_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (general_dma_read_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (general_dma_read_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (general_dma_read_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) general_dma_write_master_agent (
		.clk                   (system_pll_outclk0_clk),                                                      //       clk.clk
		.reset                 (niosII_core_reset_reset_bridge_in_reset_reset),                               // clk_reset.reset
		.av_address            (general_dma_write_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (general_dma_write_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (general_dma_write_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (general_dma_write_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (general_dma_write_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (general_dma_write_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (general_dma_write_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (general_dma_write_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (general_dma_write_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (general_dma_write_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (general_dma_write_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (general_dma_write_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (general_dma_write_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (general_dma_write_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (general_dma_write_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (general_dma_write_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) general_dma_control_port_slave_agent (
		.clk                     (system_pll_outclk0_clk),                                             //             clk.clk
		.reset                   (niosII_core_reset_reset_bridge_in_reset_reset),                      //       clk_reset.reset
		.m0_address              (general_dma_control_port_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (general_dma_control_port_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (general_dma_control_port_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (general_dma_control_port_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (general_dma_control_port_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (general_dma_control_port_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (general_dma_control_port_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (general_dma_control_port_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (general_dma_control_port_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (general_dma_control_port_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (general_dma_control_port_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (general_dma_control_port_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (general_dma_control_port_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (general_dma_control_port_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (general_dma_control_port_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (general_dma_control_port_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (general_dma_control_port_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (general_dma_control_port_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (general_dma_control_port_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (general_dma_control_port_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (general_dma_control_port_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (general_dma_control_port_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (general_dma_control_port_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (general_dma_control_port_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (general_dma_control_port_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (general_dma_control_port_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (general_dma_control_port_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (general_dma_control_port_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (general_dma_control_port_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (general_dma_control_port_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (general_dma_control_port_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (general_dma_control_port_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                                  //                .error
		.rdata_fifo_src_ready    (general_dma_control_port_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (general_dma_control_port_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (general_dma_control_port_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) general_dma_control_port_slave_agent_rsp_fifo (
		.clk               (system_pll_outclk0_clk),                                          //       clk.clk
		.reset             (niosII_core_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.in_data           (general_dma_control_port_slave_agent_rf_source_data),             //        in.data
		.in_valid          (general_dma_control_port_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (general_dma_control_port_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (general_dma_control_port_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (general_dma_control_port_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (general_dma_control_port_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (general_dma_control_port_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (general_dma_control_port_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (general_dma_control_port_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (general_dma_control_port_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                           // (terminated)
		.csr_read          (1'b0),                                                            // (terminated)
		.csr_write         (1'b0),                                                            // (terminated)
		.csr_readdata      (),                                                                // (terminated)
	...
	soc_design_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (general_dma_read_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (general_dma_read_master_agent_cp_valid),         //          .valid
		.sink_data          (general_dma_read_master_agent_cp_data),          //          .data
		.sink_startofpacket (general_dma_read_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (general_dma_read_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (system_pll_outclk0_clk),                         //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	soc_design_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (general_dma_write_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (general_dma_write_master_agent_cp_valid),         //          .valid
		.sink_data          (general_dma_write_master_agent_cp_data),          //          .data
		.sink_startofpacket (general_dma_write_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (general_dma_write_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (system_pll_outclk0_clk),                          //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	soc_design_mm_interconnect_0_router_004 router_006 (
	...
	soc_design_mm_interconnect_0_router_004 router_007 (
		.sink_ready         (general_dma_control_port_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (general_dma_control_port_slave_agent_rp_valid),         //          .valid
		.sink_data          (general_dma_control_port_slave_agent_rp_data),          //          .data
		.sink_startofpacket (general_dma_control_port_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (general_dma_control_port_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (system_pll_outclk0_clk),                                //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	soc_design_mm_interconnect_0_router_004 router_008 (
	...
	soc_design_mm_interconnect_0_router_009 router_009 (
	...
	soc_design_mm_interconnect_0_router_009 router_010 (
	...
	soc_design_mm_interconnect_0_router_004 router_011 (
	...
	soc_design_mm_interconnect_0_router_012 router_012 (
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (general_dma_control_port_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (general_dma_control_port_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (general_dma_control_port_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (general_dma_control_port_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (general_dma_control_port_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (general_dma_control_port_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_design_mm_interconnect_0_cmd_demux_002 cmd_demux_003 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_cmd_mux_008 cmd_mux_008 (
		.clk                 (system_pll_outclk0_clk),                                                         //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.sink0_ready         (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_ready),                //     sink0.ready
		.sink0_valid         (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_valid),                //          .valid
		.sink0_channel       (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_channel),              //          .channel
		.sink0_data          (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_data),                 //          .data
		.sink0_startofpacket (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_startofpacket),        //          .startofpacket
		.sink0_endofpacket   (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),          //          .endofpacket
		.sink1_ready         (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink1_channel       (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink1_data          (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.sink1_startofpacket (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
	...
	soc_design_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_demux_008 rsp_demux_008 (
		.clk                (system_pll_outclk0_clk),                        //       clk.clk
		.reset              (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink8_ready         (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_ready),         //     sink8.ready
		.sink8_valid         (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_valid),         //          .valid
		.sink8_channel       (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_channel),       //          .channel
		.sink8_data          (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_data),          //          .data
		.sink8_startofpacket (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink8_endofpacket   (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	soc_design_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink2_ready         (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_valid),         //          .valid
		.sink2_channel       (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_channel),       //          .channel
		.sink2_data          (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_data),          //          .data
		.sink2_startofpacket (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	soc_design_mm_interconnect_0_rsp_mux_002 rsp_mux_003 (
		.clk                 (system_pll_outclk0_clk),                        //       clk.clk
		.reset               (niosII_core_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) niosii_core_data_master_to_sdram_s1_cmd_width_adapter (
		.clk                  (system_pll_outclk0_clk),                                                  //       clk.clk
		.reset                (niosII_core_reset_reset_bridge_in_reset_reset),                           // clk_reset.reset
		...
		.out_endofpacket      (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (niosii_core_data_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (niosii_core_instruction_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                          // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_s1_to_niosii_core_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                   // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter (
		.clk                  (system_pll_outclk0_clk),                                                         //       clk.clk
		.reset                (niosII_core_reset_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.out_endofpacket      (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_s1_to_niosii_core_instruction_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                          // (terminated)
	);
	...
	soc_design_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (system_pll_outclk0_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (niosII_core_reset_reset_bridge_in_reset_reset),             // in_rst_0.reset
		.in_0_data      (general_dma_control_port_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (general_dma_control_port_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (general_dma_control_port_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	soc_design_mm_interconnect_0_avalon_st_adapter_008 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
