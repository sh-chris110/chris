...
(
    ...
    localparam PAD5 = log2ceil(64'h4041828 - 64'h4041820); 
    localparam PAD6 = log2ceil(64'h4041830 - 64'h4041828); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4041830;
    ...
    // ( 0x4041820 .. 0x4041828 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 27'h4041820  && read_transaction  ) begin
            src_channel = 7'b0000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x4041828 .. 0x4041830 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4041828   ) begin
