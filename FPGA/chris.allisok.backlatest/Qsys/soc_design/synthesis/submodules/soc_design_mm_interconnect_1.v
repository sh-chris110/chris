// soc_design_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module soc_design_mm_interconnect_1 (
		...
		input  wire [10:0] dma_0_read_master_address,               //                 dma_0_read_master.address
		output wire        dma_0_read_master_waitrequest,           //                                  .waitrequest
		input  wire [6:0]  dma_0_read_master_burstcount,            //                                  .burstcount
		...
		input  wire [10:0] dma_0_write_master_address,              //                dma_0_write_master.address
		output wire        dma_0_write_master_waitrequest,          //                                  .waitrequest
		input  wire [6:0]  dma_0_write_master_burstcount,           //                                  .burstcount
	...
	wire  [10:0] dma_0_read_master_translator_avalon_universal_master_0_address;        // dma_0_read_master_translator:uav_address -> dma_0_read_master_agent:av_address
	...
	wire   [8:0] dma_0_read_master_translator_avalon_universal_master_0_burstcount;     // dma_0_read_master_translator:uav_burstcount -> dma_0_read_master_agent:av_burstcount
	wire         rsp_mux_src_valid;                                                     // rsp_mux:src_valid -> dma_0_read_master_agent:rp_valid
	wire  [86:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_read_master_agent:rp_data
	...
	wire  [10:0] dma_0_write_master_translator_avalon_universal_master_0_address;       // dma_0_write_master_translator:uav_address -> dma_0_write_master_agent:av_address
	...
	wire   [8:0] dma_0_write_master_translator_avalon_universal_master_0_burstcount;    // dma_0_write_master_translator:uav_burstcount -> dma_0_write_master_agent:av_burstcount
	wire         rsp_mux_001_src_valid;                                                 // rsp_mux_001:src_valid -> dma_0_write_master_agent:rp_valid
	wire  [86:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> dma_0_write_master_agent:rp_data
	...
	wire  [10:0] convolution_slave_avs_s0_agent_m0_address;                             // convolution_slave_avs_s0_agent:m0_address -> convolution_slave_avs_s0_translator:uav_address
	...
	wire  [87:0] convolution_slave_avs_s0_agent_rf_source_data;                         // convolution_slave_avs_s0_agent:rf_source_data -> convolution_slave_avs_s0_agent_rsp_fifo:in_data
	...
	wire  [87:0] convolution_slave_avs_s0_agent_rsp_fifo_out_data;                      // convolution_slave_avs_s0_agent_rsp_fifo:out_data -> convolution_slave_avs_s0_agent:rf_sink_data
	...
	wire  [86:0] dma_0_read_master_agent_cp_data;                                       // dma_0_read_master_agent:cp_data -> router:sink_data
	...
	wire  [86:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router_001:sink_data
	...
	wire         convolution_slave_avs_s0_agent_rp_valid;                               // convolution_slave_avs_s0_agent:rp_valid -> router_002:sink_valid
	wire  [86:0] convolution_slave_avs_s0_agent_rp_data;                                // convolution_slave_avs_s0_agent:rp_data -> router_002:sink_data
	wire         convolution_slave_avs_s0_agent_rp_ready;                               // router_002:sink_ready -> convolution_slave_avs_s0_agent:rp_ready
	wire         convolution_slave_avs_s0_agent_rp_startofpacket;                       // convolution_slave_avs_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         convolution_slave_avs_s0_agent_rp_endofpacket;                         // convolution_slave_avs_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         cmd_mux_src_valid;                                                     // cmd_mux:src_valid -> convolution_slave_avs_s0_burst_adapter:sink0_valid
	wire  [86:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> convolution_slave_avs_s0_burst_adapter:sink0_data
	wire         cmd_mux_src_ready;                                                     // convolution_slave_avs_s0_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> convolution_slave_avs_s0_burst_adapter:sink0_channel
	wire         cmd_mux_src_startofpacket;                                             // cmd_mux:src_startofpacket -> convolution_slave_avs_s0_burst_adapter:sink0_startofpacket
	wire         cmd_mux_src_endofpacket;                                               // cmd_mux:src_endofpacket -> convolution_slave_avs_s0_burst_adapter:sink0_endofpacket
	...
	wire  [86:0] convolution_slave_avs_s0_burst_adapter_source0_data;                   // convolution_slave_avs_s0_burst_adapter:source0_data -> convolution_slave_avs_s0_agent:cp_data
	...
	wire   [1:0] convolution_slave_avs_s0_burst_adapter_source0_channel;                // convolution_slave_avs_s0_burst_adapter:source0_channel -> convolution_slave_avs_s0_agent:cp_channel
	...
	wire         convolution_slave_avs_s0_agent_rdata_fifo_src_valid;                   // convolution_slave_avs_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] convolution_slave_avs_s0_agent_rdata_fifo_src_data;                    // convolution_slave_avs_s0_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         convolution_slave_avs_s0_agent_rdata_fifo_src_ready;                   // avalon_st_adapter:in_0_ready -> convolution_slave_avs_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                         // avalon_st_adapter:out_0_valid -> convolution_slave_avs_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                          // avalon_st_adapter:out_0_data -> convolution_slave_avs_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                         // convolution_slave_avs_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                         // avalon_st_adapter:out_0_error -> convolution_slave_avs_s0_agent:rdata_fifo_sink_error
	...
	soc_design_mm_interconnect_1_router router (
	...
	soc_design_mm_interconnect_1_router router_001 (
	...
	soc_design_mm_interconnect_1_router_002 router_002 (
	...
	soc_design_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (system_pll_outclk0_clk),                  //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (system_pll_outclk0_clk),                  //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (system_pll_outclk0_clk),                  //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (system_pll_outclk0_clk),                  //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (system_pll_outclk0_clk),                  //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_design_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (system_pll_outclk0_clk),                  //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
