...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../soc_design.sopcinfo
...
# CPU Name 
# setting CPU_NAME is niosII_core
CPU_NAME = niosII_core
...
# Design Name 
# setting SOPC_NAME is soc_design
SOPC_NAME := soc_design
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4041820
SOPC_SYSID_FLAG += --sidp=0x4041820
ELF_PATCH_FLAG  += --sidp 0x4041820

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1504770410
SOPC_SYSID_FLAG += --timestamp=1504770410
ELF_PATCH_FLAG  += --timestamp 1504770410
